...
public class InventoryFacade {
    ...
    public Optional<Category> findCategoryByName(String name) {
        ...
        return inventoryService.findCategoryByName(name);
    }

    public Optional<Category> findCategoryById(Long id) {
        LOGGER.info("Buscando categoría por ID a través de facade: " + id);
    ...
    public void saveCategory(Category category) {
        LOGGER.info("Guardando categoría a través de facade: " + category.getName());
        inventoryService.saveCategory(category);
    }

    public void updateCategory(Category category) {
        LOGGER.info("Actualizando categoría a través de facade: " + category.getId());
        inventoryService.updateCategory(category);
    }

    public void deleteCategory(Category category) {
        LOGGER.info("Eliminando categoría a través de facade: " + category.getId());
        inventoryService.deleteCategory(category);
    }
}